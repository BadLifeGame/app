...
if (Achievements.includes(5)) {
	document.getElementById("5-details").innerHTML = "Achieved | Difficulty: Medium | Reward: 4 Stars ✓";
	document.getElementById("5-details").style.color = "green";
}

if (Achievements.includes(6)) {
	document.getElementById("6-details").innerHTML = "Achieved | Difficulty: Medium | Reward: 4 Stars ✓";
	document.getElementById("6-details").style.color = "green";
}
...
if (Achievements.includes(8)) {
	document.getElementById("8-details").innerHTML = "Achieved | Difficulty: Medium | Reward: 4 Stars ✓";
	document.getElementById("8-details").style.color = "green";
}
...
if (Achievements.includes(10)) {
	document.getElementById("10-details").innerHTML = "Achieved | Difficulty: Medium | Reward: 4 Star, $1,000 ✓";
...
document.getElementById("achsAchieved").innerHTML = Achievements.length+" / 37";