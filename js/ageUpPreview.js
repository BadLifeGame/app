...
function ifStatIsHigherLower(current, future) { //finds if difference between the current and future stats are positive or negative//
...
if (bonanza === "Joy") {
	return "Joy: " + joyUpcoming + " | " + ifStatIsHigherLower(Joy, joyUpcoming);
} else if (bonanza === "Health") {
	return "Health: " + healthUpcoming + " | " + ifStatIsHigherLower(Health, healthUpcoming);
} else if (bonanza === "Intellect") {
	return "Intellect: " + intellectUpcoming + " | " + ifStatIsHigherLower(Intellect, intellectUpcoming);
} else if (bonanza === "Looks") {
	return "Looks: " + looksUpcoming + " | " + ifStatIsHigherLower(Looks, looksUpcoming);
} else if (bonanza === "Karma") {
	return "Karma: " + karmaUpcoming + " | " + ifStatIsHigherLower(Karma, karmaUpcoming);
} else if (bonanza === "Evality") {
	return "Evality: " + evalityUpcoming + " | " + ifStatIsHigherLower(Evality, evalityUpcoming);
}
}
